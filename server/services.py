...
class TransactionService(object):
    ...
    @classmethod
    def transactions(cls, page=1, pagesize=10, currency="ILC"):
    ...
    @classmethod
    def total_transactions(cls, currency="ILC"):
...
class OutputService(object):
    ...
    @classmethod
    def locked_height(cls, address, height, currency="ILC"):
        return orm.select(
    ...
    @classmethod
    def locked_time(cls, address, time, currency="ILC"):
        return orm.select(
